...
class _DistractorBase(SimpleGramChoice):
    choices = [
        ...
        f"I think they were {VerbTalkingTo} {PluralRobotsOrHumans}",
        ...
        f"Is that like {ARobot}?",
        f"Are you a robot, a chatbot, or an AI?",
        f"Are you able to tell a computer it is a machine?",
        f"Do you use AI?",
        f"Is AI machine learning?",
        f"Did you know that machines can learn?",
        (f"Is that the same thing as {ARobot}?", 3),
        (f"How that different from being {ARobotOrHuman}?", 1),
        f"Is that the same?",
